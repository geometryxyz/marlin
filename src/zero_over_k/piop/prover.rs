...
use crate::zero_over_k::error::Error;
use crate::zero_over_k::util::*;
...
impl<F: PrimeField, VO: VirtualOracle<F>, FS: FiatShamirRng> PIOPforZeroOverK<F, VO, FS> {
    ...
    pub fn prover_first_round<'a, R: Rng>(
        ...
        let f_prime_evals =
            state
                .virtual_oracle
                .instantiate_in_evals_form(h_primes.as_slice(), &alphas, domain).map_err(Error::from_vo_error)?;
